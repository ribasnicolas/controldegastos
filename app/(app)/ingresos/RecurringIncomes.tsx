...
import { EditRecurringIncomeSheet } from "./EditRecurringIncomeSheet";
    ...
    <section className="card-surface">
      ...
      >
        <span className="text-sm font-semibold text-gray-700">
          Ingresos fijos (recurrentes){items.length > 0 ? ` · ${items.length}` : ""}
        </span>
      ...
      {editing && (
        <EditRecurringIncomeSheet item={editing} categories={categories} onClose={() => setEditing(null)} />
      )}
    </section>
  );
}
