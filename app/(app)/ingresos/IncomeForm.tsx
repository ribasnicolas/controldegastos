...
export function IncomeForm({ categories, year, month }: { categories: Category[]; year: number; month: number }) {
    ...
    <section className="card-surface">
      ...
      >
        <span className="text-sm font-semibold text-gray-700">
          {isCurrentMonth ? "Cargar ingreso" : `Cargar ingreso de ${monthLabel(month, year).toLowerCase()}`}
        </span>
