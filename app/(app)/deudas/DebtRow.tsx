      ...
      <div className="min-w-0">
        <p
          className={`text-sm truncate ${
            debt.settled ? "line-through text-gray-400 dark:text-gray-500" : "text-gray-900 dark:text-gray-100"
          }`}
        >
          {debt.personName}
      ...
      <div className="flex items-center gap-2 shrink-0">
        <span
          className={`text-sm font-semibold ${
            debt.settled ? "text-gray-400 dark:text-gray-500 line-through" : "text-gray-900 dark:text-gray-100"
          }`}
        >
